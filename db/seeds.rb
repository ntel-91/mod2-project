...
Show.destroy_all
zach_galifianakis = Show.create!(show_name: "Zach Galifianakis", genre: "Comedy", show_cover: "https://i.ebayimg.com/images/g/jMYAAOSwyQtV3gqE/s-l300.jpg", show_or_movie: true)
          columbo = Show.create!(show_name: "Columbo", genre: "Mystery", show_cover: "https://media.cozitv.com/images/700*394/COLUMBO+Thumbnail.jpg", show_or_movie: true)
              h2o = Show.create!(show_name: "H2O", genre: "Young Adult", show_cover: "https://images-na.ssl-images-amazon.com/images/I/81nZ+dx8NhL._RI_.jpg", show_or_movie: true)
  whats_happening = Show.create!(show_name: "What's Happening!!", genre: "Comedy", show_cover: "https://upload.wikimedia.org/wikipedia/en/7/7d/Whatshappening.jpg", show_or_movie: true)
     black_saddle = Show.create!(show_name: "Black Saddle", genre: "Mystery", show_cover: "https://image.tmdb.org/t/p/w500_and_h282_face/v7PBbC7163SHiBpWnQpJH1PZZzc.jpg", show_or_movie: true)
     the_rifleman = Show.create!(show_name: "The Rifleman", genre: "Mystery", show_cover: "https://i.ytimg.com/vi/yW6Ki8wpL5s/hqdefault.jpg", show_or_movie: true)
           combat = Show.create!(show_name: "Combat!", genre: "Mystery", show_cover: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdpChJDOv9OGQoF8w1dLI6gxF7lLwmpXXGsnLYa1J8N6-vd8iI", show_or_movie: true)
      invader_zim = Show.create!(show_name: "Invader Zim", genre: "Young Adult", show_cover: "https://static3.cbrimages.com/wordpress/wp-content/uploads/2018/07/invader-zim-header.jpg", show_or_movie: true)
       good_times = Show.create!(show_name: "Good Times", genre: "Comedy", show_cover: "https://vignette.wikia.nocookie.net/goodtimes/images/c/c3/Good-Times-1.jpg/revision/latest?cb=20140804022418", show_or_movie: true)
           django = Show.create!(show_name: "Django Unchained", genre: "Action", show_cover: "https://media-assets-04.thedrum.com/cache/images/thedrum-prod/s3-news-tmp-116055-pic_1561903--2x1--940.jpg", show_or_movie: false)
   den_of_theives = Show.create!(show_name: "Den of Thieves", genre: "Action", show_cover: "https://cdn.traileraddict.com/vidquad/stx-entertainment/den-of-thieves-poster/1.jpg", show_or_movie: false)
         movie_43 = Show.create!(show_name: "Movie 43 ", genre: "Comedy", show_cover: "https://cdn3.movieweb.com/i/article/0B6RaD3Q1xSWIylr3UZVjpo4XxK0EO/798:50/Movie-43-Poster.jpg", show_or_movie: false)
     dark_phoenix = Show.create!(show_name: "X-Men: Dark Phoenix", genre: "Action", show_cover: "https://www.microcapobserver.com/root_upld/general-news/2019/06/ART576325909127479/org_40096201906141233.jpg", show_or_movie: false)
       highlander = Show.create!(show_name: "Highlander", genre: "Action", show_cover: "https://www.originalposter.co.uk/uploads/938991725444793_mainphotos.jpg", show_or_movie: false)
        lion_king = Show.create!(show_name: "The Lion King ", genre: "Young Adult", show_cover: "https://images.justwatch.com/backdrop/243658/s1440/the-lion-king", show_or_movie: false)
           frozen = Show.create!(show_name: "Frozen", genre: "Young Adult", show_cover: "https://hdqwalls.com/download/elsa-in-frozen-1920x1080.jpg", show_or_movie: false)
          aladdin = Show.create!(show_name: "Aladdin", genre: "Young Adult", show_cover: "https://i0.wp.com/hnentertainment.co/wp-content/uploads/2019/06/DISNEY_GUY-RITCHIE_ALADDIN_500-MILLION_.jpg?fit=1484%2C742&ssl=1", show_or_movie: false)
          aquaman = Show.create!(show_name: "Aquaman", genre: "Action", show_cover: "https://www.geek.com/wp-content/uploads/2018/11/Home-is-Calling-Aquaman-Poster-690-625x352.jpg", show_or_movie: false)
